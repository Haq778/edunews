                ...
                <div class="text-gray-700 dark:text-gray-300 leading-8 space-y-4">
                  ...
                  <template v-else>
                    ...
                    <p class="text-justify">
                      Berita pendidikan ini membahas perkembangan terkini dalam dunia pendidikan 
                      yang sedang menjadi perhatian publik. Konten lengkap akan segera tersedia 
                      untuk memberikan informasi yang lebih mendalam tentang topik ini.
                    </p>
                    <p class="text-justify">
                      Pendidikan merupakan fondasi penting bagi kemajuan bangsa. Melalui berbagai 
                      inovasi dan terobosan dalam metode pembelajaran, diharapkan dapat menciptakan 
                      generasi yang lebih berkualitas dan siap menghadapi tantangan masa depan.
                    </p>
                  </template>
                </div>
              </div>
...
// 🔥 FIX PENTING: Konsisten dengan NewsCard.vue
const coverUrl = computed(() => {
  if (!props.article?.cover) {
    return '/default-cover.jpg'   // fallback jika tidak ada cover
  }
  
  // Gunakan path yang sama dengan NewsCard.vue
...
function handleImageError(event) {
  console.error('Error loading image:', props.article?.cover)
